...
import pandas as pd
from ontoAlign.model.nlfoa import NLFOA
from ontoAlign.util import set_random_seeds
from ontoAlign.data.model.ontology import Ontology
from ontoAlign.data.model.predicted_alignment_rankings import PredictedAlignmentRankings, PREDICTED_ALIGNMENT_RANKINGS_FILE_EXTENSION
from ontoAlign.data.model.reference_alignments import ReferenceAlignments, REFERENCE_ALIGNMENTS_FILE_EXTENSION
from ontoAlign.data.preprocessing.rdflib_ontology_parser import RDFLibOntologyParser
from ontoAlign.data.preprocessing.owlready2_ontology_parser import OwlReady2OntologyParser
from ontoAlign.data.preprocessing.pseudo_sentence_generator import PSEUDO_SENTENCE_CACHE_FILE_EXTENSION, PseudoSentenceGenerator
from ontoAlign.data.preprocessing.reference_alignments_parser import RDFLibAlignmentFormatReferenceAlignmentsParser
from ontoAlign.model.pseudo_sentence_encoder import PseudoSentenceEncoder, SBertPSE
from ontoAlign.model.similarity import compute_similarities
from omegaconf import DictConfig, OmegaConf
from ontoAlign.scoring import compute_score_dict
